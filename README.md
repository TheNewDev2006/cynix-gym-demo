# Cynix Gym Demo Website

Professional gym website template for Cynix Inc cold outreach.
...
```
https://your-demo-url.vercel.app?name=Elite%20Gym&phone=0712345678&address=Colombo%2005&owner=Kamal
```

| Parameter | Description | Example |
|-----------|-------------|---------|
| `name` | Gym Business Name | Elite Fitness |
| `phone` | Contact Number | 0712345678 |
| `address` | Location | Colombo 05 |
| `owner` | Owner Name | Kamal |
